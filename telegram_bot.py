...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    await update.message.reply_html(rf"Halo {user.mention_html()}! Saya Tasiah, saya akan memberikan Anda artikel islami sesuai pertanyaan Anda!",reply_markup=ForceReply(selective=True))
